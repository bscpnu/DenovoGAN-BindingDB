...
class CustomSaver(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        if epoch % 20 == 0:  # or save after some epoch, each k-th epoch etc.
            self.encoder.save("model_vae_comp/encoder/encoder_{}.h5".format(epoch))
            self.decoder.save("model_vae_comp/decoder/decoder_{}.h5".format(epoch))
...
if __name__ == '__main__':
    ...
    g_model.fit(ls_compound, ls_compound, batch_size=50, epochs=200, callbacks=[saver])